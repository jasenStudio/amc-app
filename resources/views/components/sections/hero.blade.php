...
<section id="hero" aria-labelledby="hero-title" class="relative isolate overflow-hidden bg-amc-blue">
    <picture>
    ...
    <div class="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 py-24 lg:px-8">
        <div class="max-w-2xl text-white">
            ...
            <h1 id="hero-title" class="text-5xl font-semibold tracking-tight sm:text-6xl lg:text-7xl">
