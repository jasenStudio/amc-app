...
<section id="hero" style="background-color: #00203f" aria-labelledby="hero-accessible-title"
    ...
    <picture>
        ...
        <img src="{{ asset('assets/images/hero-seguridad-trabajo-alturas-amc.webp') }}"
            ...
            fetchpriority="high"
            class="fade-in absolute inset-0 h-full w-full object-cover object-[70%_20%] md:object-[80%_10%] grayscale-15">
    </picture>

    <div class="fade-in hero-gradient absolute inset-0" aria-hidden="true"></div>
    ...
    <div class="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 py-24 lg:px-8">
        <div class="max-w-2xl text-white">
            ...
            <p class="fade-in-up mb-6 text-sm font-semibold uppercase tracking-[0.24em] text-amc-orange">
                {{ __('Certificación ONAC / Res. 4272') }}</p>
            <h2 class="fade-in-up fade-in-up-delay-1 text-5xl font-semibold tracking-tight sm:text-6xl lg:text-7xl">
                {{ __('Protegemos vidas mediante') }}
                <span class="text-amc-orange">
                    {{ __('soluciones certificadas.') }}
                </span>
            </h2>
            <p class="fade-in-up fade-in-up-delay-2 mt-6 max-w-xl text-lg leading-8 text-white/80">
