<svg class="w-4 -scale-x-100" viewBox="-0.5 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <g id="SVGRepo_iconCarrier"><title>reply</title>
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
            <g id="Icon-Set" sketch:type="MSLayerGroup" transform="translate(-100.000000, -1193.000000)" fill="{{config('commenter.primary_color')}}" class="dark:fill-red-500!">
                <path
                    ...
                    id="reply" sketch:type="MSShapeGroup"></path>
            </g>
        </g>
    </g>
</svg>
