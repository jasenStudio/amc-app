...
>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="h-full flex flex-col items-center justify-center no-dark:text-black"
                >
                    <div
            ...
            <div @class(["w-full md:w-[96%] min-w-0" => Helpers::isModernTheme()])>
                        ...
                        <div class="relative flex items-center justify-center gap-x-2">
                            ...
                            >
                                ...
                                <ul
                                    ...
                                    x-transition
                                    class="absolute bottom-4 end-[0.8rem] z-10 min-w-32 space-y-1 rounded border  bg-white no-dark:border-slate-900 no-dark:bg-slate-800 p-1 shadow-lg"
                                >
                                    ...
                                    @if ($model->canEditComment($comment))
                                        <li
                                            ...
                                            @class([
                                                "hover:bg-[" . config('commenter.hover_color') . "]!",
                                                "flex items-center gap-x-2 rounded p-2 no-dark:hover:bg-slate-900!"
                                            ])
                                        >
                ...
                <div
                    class="flex bg-gray-200 my-4 justify-center items-center h-px max-w-[10%] mx-auto bg-linear-to-r from-transparent via-gray-100 to-transparent">
                </div>
                    ...
                    >
                        ...
                        >
                            <x-commenter::link
                                type="popup"
                                @class([
                                    "mx-2 no-dark:text-white! inline-flex text-xs items-center transition no-dark:bg-slate-900! no-dark:hover:bg-slate-800! *:pe-1",
        ...
        >
            <div
                class="flex bg-gray-200 mb-6 justify-center items-center h-px max-w-full mx-auto bg-linear-to-r from-transparent via-gray-100 to-transparent">
            </div>
