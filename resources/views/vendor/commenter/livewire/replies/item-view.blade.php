...
>
    <div
        @class([
            "flex flex-col gap-x-2 sm:gap-x-4",
            "flex flex-row!" => !Helpers::isModernTheme(),
        ])
    >
        <div
            @class([
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            <span class="text-sm font-semibold sm:hidden me-px">
                                {{ Str::limit($reply->ownerName($authMode), 10) }}
                            </span>

                            <span
                                class="hidden text-sm font-semibold sm:inline me-px"
                            >
                    ...
                    @if ($canManipulate)
                        <div class="relative flex items-center justify-center gap-x-2">
                            @if($reply->is_pinned)
                                <span
                                    class="absolute top-[-45px] right-[-35px] font-bold text-sm"
                                    title="{{__('Pinned')}}"
                                >
    ...
    @if($showReplyList)
        <div @class([
                "ml-6",
                "ml-2!" => Helpers::isModernTheme()
        ])
        >
            <div
                class="flex bg-gray-200 mb-6 mt-4 justify-center items-center h-px max-w-full mx-auto bg-linear-to-r from-transparent via-gray-100 to-transparent">
            </div>
