    ...
    <main>
        <section aria-labelledby="service-title" class="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            <a href="{{ route('services') }}"
                class="inline-flex items-center gap-2 text-sm font-semibold text-amc-orange transition hover:text-amc-orange-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amc-orange focus-visible:ring-offset-2">
            ...
            <div class="mt-10 grid items-center gap-10 lg:grid-cols-2">
                ...
                <div>
                    <p class="text-sm font-semibold uppercase tracking-[0.2em] text-amc-orange">{{ __('Servicio') }}</p>
                    ...
                    <a href="{{ route('home') }}#contact"
                        class="mt-8 inline-flex rounded-md bg-amc-orange px-6 py-3 text-sm font-semibold text-white transition hover:bg-amc-orange-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amc-orange focus-visible:ring-offset-2">
