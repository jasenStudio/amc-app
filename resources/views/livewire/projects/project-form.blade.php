            ...
            <div class="space-y-6 lg:col-span-2">
                <div class="space-y-2">
                    <flux:input wire:model.live.debounce.500ms="title" :label="__('title')" autofocus
                        :label:badge="__('required_field')" data-test="project-title" />
                </div>
                ...
                <div class="space-y-2">
                    <flux:textarea wire:model.live.blur="description" :label="__('description')" rows="6"
                        :label:badge="__('required_field')" data-test="project-description" />
                </div>

                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="space-y-2">
                        <flux:input wire:model.live.blur="client" :label="__('client')"
                            :label:badge="__('required_field')" data-test="project-client" />
                    </div>
                    <div class="space-y-2">
                        <flux:input wire:model.live.blur="location" :label="__('location')"
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="space-y-2">
                        <flux:input wire:model.live.blur="date" :label="__('project_date')" type="date"
                            :label:badge="__('required_field')" data-test="project-date" />
                    </div>
                    <div class="space-y-2">
                ...
                <div class="space-y-2">
                    <flux:input wire:model.live.blur="video_url" :label="__('video_url')" type="url"
                        :description="__('video_url_hint')" placeholder="https://www.youtube.com/watch?v=..."
                        data-test="project-video-url" />
                </div>
