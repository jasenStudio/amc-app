    ...
    @if ($existingThumbUrl && !$upload)
        <div class="relative group">
            <img src="{{ $existingThumbUrl }}" alt=""
                class="w-full rounded-md object-cover aspect-video" data-test="current-cover">
        ...
        @if ($upload)
            <div class="space-y-2">
                <img src="{{ $upload->temporaryUrl() }}" alt="{{ __('Preview') }}"
                    class="w-full rounded-md object-cover aspect-video" data-test="cover-preview">
