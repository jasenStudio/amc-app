    ...
    <form wire:submit="save" class="space-y-6">
        <div class="grid gap-6 lg:grid-cols-3">
            <div class="space-y-6 lg:col-span-2">
                <div class="space-y-2">
                    <flux:input wire:model.live.debounce.250ms="title" :label="__('Title')" required autofocus
                    ...
                    <div class="space-y-3">
                        ...
                        @if ($post?->cover_image_thumb && !$cover_upload && !$should_remove_cover)
                            <img src="{{ \App\Support\ImageUrl::public($post->cover_image_thumb) }}" alt=""
                                class="size-full rounded-md object-cover" data-test="current-cover">
                            <flux:button type="button" variant="ghost" icon="trash" wire:click="removeCover"
